# -*- coding: utf-8 -*-
"""
Created on Wed May  6 01:13:48 2020
...
def init_obstacles(configNum):  #initialized the obstacle
    ...
    if (configNum == 1):
        ...
        rectObs.append(pygame.Rect((365, 1030-175), (15,175)))
        rectObs.append(pygame.Rect((315, 255), (15,260)))
        rectObs.append(pygame.Rect((315, 515), (350,15)))
        rectObs.append(pygame.Rect((725, 705), (15,325)))

        rectObs.append(pygame.Rect((0, 0), (650, 255))) #big rect
        rectObs.append(pygame.Rect((0, 0), (1130, 15))) #top border
        rectObs.append(pygame.Rect((0, 1015), (1130, 15))) #bottom border
        rectObs.append(pygame.Rect((0, 0), (15, 1030)))  # left border
        rectObs.append(pygame.Rect((1115, 0), (15, 1030)))  # right border

    for rect in rectObs:
        pygame.draw.rect(screen, black, rect)
        pygame.draw.circle(screen,black,(865,315),100)
    ...
    while True:
        if currentState == 'init':
            ...
            while currNode.parent != None:
                pygame.draw.line(screen,red,currNode.point,currNode.parent.point,3)
            ...
            if count < NUMNODES:
                ...
                pygame.draw.line(screen,blue,parentNode.point,newnode,3)
                pygame.draw.line(screen,green,parentNode.point,newnode2,3)
                pygame.draw.line(screen,dark_green,parentNode.point,newnode3,3)
                ...
                if currentState == 'init':
                    if initPoseSet == False:
                        ...
                        if collides(e.pos) == False:
                            ...
                            goalPoseSet = True
                            pygame.draw.circle(screen, cyan, goalPoint.point, GOAL_RADIUS)
