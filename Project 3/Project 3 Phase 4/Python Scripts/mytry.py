...
while not rospy.is_shutdown():
    for index in range(len((translated_ros_backtracked_points))):
        ...
        print'current coordinates are : ', (x,y)
        if abs(angle_to_goal - theta) > 5:
            ...
            speed.angular.z = 0.0
            rospy.sleep(3)
        # print(val_returned,'at',coordinates) 
        pub.publish(speed)
        r.sleep()
