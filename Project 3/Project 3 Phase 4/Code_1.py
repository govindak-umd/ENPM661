...
if __name__ == '__main__':
    try:
        ...
        for index in range(len(translated_ros_backtracked_points)-1):
            ...
            print '------------------------------------'
            print 'neighbour > ', goal_x,goal_y,')'
            print '------------------------------------'
            while (x - goal_x)**2 + (y - goal_y)**2 > 0.4:
                # print('WHIL - ED AGAIN')
                if abs(math.degrees(theta)-abs(math.degrees(atan2(goal_y - round(y,2) ,goal_x - round(x,2)))))<4:
                    ...
                    if abs(math.degrees(theta)-abs(math.degrees(atan2(goal_y - round(y,2) ,goal_x - round(x,2))))) <4:
                        ...
                        # print('going to rotate : matching ',math.degrees(theta),'to',angle_to_goal)
                    if math.degrees(theta)-abs(math.degrees(atan2(goal_y - round(y,2) ,goal_x - round(x,2)))) > 0:
                        ...
                        h.append((round(x,2),round(y,2)))
                    elif math.degrees(theta)-abs(math.degrees(atan2(goal_y - round(y,2) ,goal_x - round(x,2)))) < 0:
                        # print 'angle is > : ', math.degrees(theta)-abs(math.degrees(atan2(goal_y - round(y,2) ,goal_x - round(x,2))))
