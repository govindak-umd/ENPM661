# -*- coding: utf-8 -*-
"""
Created on Wed Apr  8 12:52:11 2020
...
print('Range of x coordinates you can enter  =  -4.9 to 4.9')
print('Range of y coordinates you can enter  = 4.9 to 4.9')
print("Clearance Range = 0-0.5")
print('Wheel radius is calculated to be 76mm/2 -> approximating to 0.5')
start_x, start_y, start_orientation = input("Enter the x and y coordinate of the start and the initial orientation here, with a blank in between them (suggested: -4.9 -4.9 30 : > ").split()
goal_x, goal_y =  input("Enter the x and y coordinate of the goal and the , in the form of blanks (suggested : 4.9 4.9) : > ").split()
...
#start = (int(x_start+radius),int(y_start+radius))
