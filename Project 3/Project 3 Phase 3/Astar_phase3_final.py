...
goal_x = float(goal_x)
goal_y = float(goal_y)
x_start = (start_x+5.1)*100
y_start = (start_y+5.1)*100
x_goal = (goal_x+5.1)*100
y_goal = (goal_y+5.1)*100
...
if start in untraversable_points or goal in untraversable_points or start_x<-4.9 or start_x>4.9 or start_y<-4.9 or start_y>4.9 or goal_x<-4.9 or goal_x>4.9 or goal_y<-4.9 or goal_y>4.9:
    print("Breaking. START or GOAL in Obstacle space. Please provide valid inputs")
else:
    time_run = 1
